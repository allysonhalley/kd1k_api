...
class ParentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parent" do
    assert_difference('Parent.count') do
      post parents_url, params: { parent: { father: @parent.father, mother: @parent.mother, person_id: @parent.person_id } }, as: :json
    end
  ...
  test "should update parent" do
    patch parent_url(@parent), params: { parent: { father: @parent.father, mother: @parent.mother, person_id: @parent.person_id } }, as: :json
    assert_response 200
  end
