...
###
# rails g scaffold Rank name:string sign:string type:string code_type:string raking:integer
...
# rails g scaffold Military_data person:references general_register:string into_register:string started_in:date rank:string warname:string cas_partner:boolean
...
# rails g scaffold Blood person:references group:string type:string
